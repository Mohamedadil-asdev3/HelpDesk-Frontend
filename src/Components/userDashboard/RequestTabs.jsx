   ...
   const handleApproveSolution = async () => {
    ...
    const handleChatDrawerOpen = async (ticketNo) => {
        ...
        try {
            ...
            setAssignee(assigneeDetail);
            setClarificationRequested(ticketData.status === "157" || ticketData.clarification_requested);
            // Set ticket details
            setCurrentChatTicket({
                id: ticketNo,
                title: ticketData.title || ticket.title || "",
                    ...
                    <Box sx={{ flex: 1 }}>
                        ...
                        {chatTab === 1 && isSolvedTicket && (
                            <Box sx={{ p: 4, textAlign: "center", color: "text.secondary" }}>
                                <DoneAllIcon sx={{ fontSize: 60, opacity: 0.5, mb: 2 }} />
                        ...
                        {chatTab === 2 && !isSolvedTicket && (
                            <Box sx={{ p: 4, textAlign: "center", color: "text.secondary" }}>
                                <DoneAllIcon sx={{ fontSize: 60, opacity: 0.5, mb: 2 }} />
                                <Typography>Cannot request clarification on solved tickets.</Typography>
                                <Button variant="text" onClick={() => setChatTab(0)} sx={{ mt: 2 }}>
                                    Back to Chat
                                </Button>
                            </Box>
                        )}
